...
MyData=read.csv('C:\\Users\\nicho\\Google Drive\\School\\Graduate School\\Kent State\\Fall 2019\\Business Analytics\\Occupancy_Detection.csv'); 
...
MyData=read.csv('C:\\Users\\nicho\\Google Drive\\School\\Graduate School\\Kent State\\Fall 2019\\Business Analytics\\Occupancy_Detection_Missing.csv'); 
